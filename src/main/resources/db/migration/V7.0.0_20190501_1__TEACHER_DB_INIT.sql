...
CREATE TABLE `school` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='学校表';
...
INSERT INTO `school` VALUES ('22', '长安大学', '长安', '长安', 'http://www.ca.cn', '本科', '理工类');
...
-- ----------------------------
INSERT INTO `school_line` VALUES ('4', '20', '123', '文科', null);
INSERT INTO `school_line` VALUES ('5', '21', '123', '文科', null);
INSERT INTO `school_line` VALUES ('6', '21', '233', '理科', null);
...
CREATE TABLE `school_profession` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='学校专业表';
...
CREATE TABLE `scoreline` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='省控线';
