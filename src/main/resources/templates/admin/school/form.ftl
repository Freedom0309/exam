                ...
                <form id="form1" class="layui-form "  lay-filter="form">
                    ...
                    <div class="layui-form-item" style="margin-top: 10px">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="name" lay-verify="required"  placeholder="请输入学校名称" value="${school.name}"
                    ...
                    <div class="layui-form-item" style="margin-top: 10px">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="description" lay-verify="required"  placeholder="请输入简介" value="${school.description}"
                                   autocomplete="off" class="layui-input ">
                        </div>
                        <span style="color: red">必填</span>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="address" lay-verify="required" placeholder="请输入地址" value="${school.address}"
                                   autocomplete="off" class="layui-input">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="level" lay-verify="required" placeholder="请输入招生层次" value="${school.level}"
                                   autocomplete="off" class="layui-input">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="type" lay-verify="required" placeholder="请输入学校类型" value="${job.title}"
                                   autocomplete="off" class="layui-input">
